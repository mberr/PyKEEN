...
MARGIN_LOSSES_PROMPT_MSG = '> Margin loss(es)'
...
EMBEDDING_DIMENSIONS_PROMPT_MSG = '> Embedding dimensions (comma separated)'
...
RELATION_EMBEDDING_DIMENSIONS_PRINT_MSG = ''
RELATION_EMBEDDING_DIMENSIONS_PROMPT_MSG = '> Relation embedding dimensions, comma-separated'
